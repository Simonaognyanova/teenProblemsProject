...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>Teen Problems | За нас</title>
...
<button type="submit" name="update" class="btn btn-success waves-effect waves-light">Обнови и публикувай</button>
                                        </form>
                                    </div>
                                </div> <!-- end p-20 -->
                            </div> <!-- end col -->
