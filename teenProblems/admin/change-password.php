...
{
$error="Старата парола не съвпада !!";
}
}
?>
...
<html lang="en">
    <head>
        ...
        <title>Teen Problems | Добави категория</title>
                ...
                <div class="content">
                    <div class="container">
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Промени парола</h4>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title"><b>Промяна на парола </b></h4>
                                    <hr />
...
<label class="col-md-4 control-label">Настояща парола</label>
<div class="col-md-8">
...
<div class="form-group">
<label class="col-md-4 control-label">Нова парола</label>
<div class="col-md-8">
