...
if($query)
{
$msg="Страницата 'За нас' е обновена успешно.";
}
else{
...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>Teen Problems | Контакти</title>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Контакти </h4>
    ...
    <div class="col-md-10 col-md-offset-1">
        <div class="p-6">
            <div class="">
                ...
                <label for="exampleInputEmail1">Заглавие на страницата</label>
        ...
        <div class="row">
            <div class="col-sm-12">
            <div class="card-box">
                <h4 class="m-b-30 m-t-0 header-title"><b>Подробности за страницата</b></h4>
...
<button type="submit" name="update" class="btn btn-success waves-effect waves-light">Обнови пост</button>
    </form>
</div>
</div> <!-- end p-20 -->
</div> <!-- end col -->
