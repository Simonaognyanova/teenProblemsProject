...
if($query)
{
$msg="Категорията е обновена успешно. ";
}
else{
...
<html lang="en">
    <head>
        <title>Teen Problems | Добавяне на категория</title>
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Редактирай категория</h4>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title"><b>Редактирай категория </b></h4>
                                    <hr/>
...
<div class="row">
    <div class="col-md-6">
        ...
        <div class="form-group">
	        <label class="col-md-2 control-label">Описание на категория</label>
	        <div class="col-md-10">
...
<?php } ?>
        ...
        <label class="col-md-2 control-label">&nbsp;</label>
            <div class="col-md-10">                                              
                <button type="submit" class="btn btn-custom waves-effect waves-light btn-md" name="submit">Обнови</button>
            </div>
        </div>
    </form>
</div></div></div></div></div>
