...
if($query)
{
$msg="Подкатегорията е създадена. ";
}
else{
...
<html lang="en">
    <head>
        ...
        <title>Teen Problems | Редактиране на подкатегорията</title>
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Добавете подкатегория</h4>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title"><b>Добавете подкатегория </b></h4>
                                    <hr/>
...
<div class="form-group">
    ...
    <div class="form-group">                                            
        <label class="col-md-2 control-label">Описание на подкатегория</label>
	        <div class="col-md-10">
...
<label class="col-md-2 control-label">&nbsp;</label>
    <div class="col-md-10">                                              
    <button type="submit" class="btn btn-custom waves-effect waves-light btn-md" name="submitsubcat">Изпрати</button>
    </div>
</div>
</form>
</div></div></div></div></div>
