...
if($_GET['action']=='parmdel' && $_GET['rid'])
{
	...
	$delmsg="Категорията е изтрита успешно.";
}
...
<html lang="en">
    <head>
        ...
        <title>Teen Problems | Управление на категории</title>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Управление на категории</h4>
...
<div class="m-b-30">
 ...
 <h4><i class="fa fa-trash-o" ></i> Изтрити категории</h4>
