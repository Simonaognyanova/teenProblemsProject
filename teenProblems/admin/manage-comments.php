...
<html lang="en">
    <head>
        ...
        <title>Teen Problems | Управление на коментарите</title>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Управление на одобрените коментари</h4>
