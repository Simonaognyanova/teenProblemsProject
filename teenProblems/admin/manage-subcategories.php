...
if($_GET['resid'])
{
	...
	$msg="Категорията е възстановена успешно.";
}
...
<html lang="en">
    <head>
        ...
        <title> Teen problems | Редактиране на подкатегория</title>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Управление на подкатегории</h4>
                                    <ol class="breadcrumb p-0 m-0">
                                        <li>
                                            <a href="#">Админ</a>
                                        </li>
                                        <li>
                                            <a href="#">Подкатегиря </a>
                                        </li>
                                        <li class="active">
			...
			<div class="demo-box m-t-20">
                <div class="m-b-30">
                    <a href="add-subcategory.php">
                        <button id="addToTable" class="btn btn-success waves-effect waves-light">Добави <i class="mdi mdi-plus-circle-outline" ></i></button>
                    </a>
                </div>
                    ...
                    <table class="table m-0 table-colored-bordered table-bordered-primary">
                        <thead>
                            <tr>
                                ...
                                <th>Дата на последното обновяване</th>
                                <th>Функция</th>
                            </tr>
                        </thead>
                    <tbody>
...
<td colspan="7" align="center"><h3 style="color:red">Не е намерен запис</h3></td>
<tr>
<?php 
} else {
...
<div class="m-b-30">
 ...
 <h4><i class="fa fa-trash-o" ></i> Изтрити подкатегории</h4>
