...
<html lang="en">
    <head>
        ...
        <title>Teen Problems | Редактиране на категории</title>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Управление на неодобрените коментари</h4>
...
<td>
<?php if($st=='0'):?>
    <a href="unapprove-comment.php?disid=<?php echo htmlentities($row['id']);?>" title="Не одобрявам този коментар"><i class="ion-arrow-return-right" style="color: #29b6f6;"></i></a> 
<?php else :?>
  <a href="unapprove-comment.php?appid=<?php echo htmlentities($row['id']);?>" title="Одобрете този коментар"><i class="ion-arrow-return-right" style="color: #29b6f6;"></i></a> 
<?php endif;?>
