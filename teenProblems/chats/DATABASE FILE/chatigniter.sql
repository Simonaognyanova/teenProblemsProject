...
CREATE TABLE `user` (
  ...
  `user_avtar` varchar(200) CHARACTER SET utf8mb4 NOT NULL,
  `user_status` varchar(10) CHARACTER SET utf8mb4 NOT NULL,
  `last_logout` varchar(30) CHARACTER SET utf8mb4 NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;
...
CREATE TABLE `user_messages` (
  ...
  `sender_message_id` varchar(20) CHARACTER SET utf8mb4 NOT NULL,
  `receiver_message_id` varchar(20) CHARACTER SET utf8mb4 NOT NULL,
