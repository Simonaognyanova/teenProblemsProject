			...
			<div class="row form_row">
				<div class="col-lg-4 bg-white px-3 py-3" id="form_col">
					<form autocomplete="off" id="form_login">
						<h3 class="text-center">Teen Problems - Chats</h3>
						...
						<div class="field_container">
							...
							<div class="form-group my-0 pt-2 justify-content-end d-flex">
								<div>
									...
									<label for="chkbox1" class="mr-0">Показване на парола</label>
								</div>
							</div>
							<div class="form-group">
							...
							<h6 class="text-center">Нямате профил? <a href="index.php/signup" style="text-decoration:none;">Регистрация</a></h6>
