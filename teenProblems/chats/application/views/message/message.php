...
<head>
	...
	<title>Teen Problems - Chat</title>
</head>
<body>
	<section id="main" class="bg-dark">
		<div id="chat_user_list">
			<div id="owner_profile_details">
				...
				<div id="owner_profile_text" class="">
					...
					<a class="text-decoration-none" href="" id="logout" style="color:#e86663;"><i class="fa fa-power-off"></i> Изход</a>
				</div>
			</div>
			<div id="search_box_container" class="py-3">
				<input type="text" name="txt_search" class="form-control" autocomplete="off" placeholder="Търсене" id="search">
			</div>
			<hr/>
		...
		<div id="chatbox">
			<div id="data_container" class="">
				<div id="bg_image"></div>
				<h2 class="mt-0">Здравейте! Добре дошли в</h2>
				<h2>Teen Problems - Chat</h2>
				<p class="text-center my-2">Свържете се с вашето устройство чрез интернет. Не забравяйте, че вие <br> трябва да имате стабилна интернет връзка за<br> по-добри контакти.</p>
			</div>
				...
				<div id="messageBar" class="py-4 px-4">
					<div id="textBox_attachment_emoji_container">
						<div id="text_box_message">
							<input type="text" maxlength = "200" name="txt_message" id="messageText" class="form-control" placeholder="Въведете съобщение">
						</div>
						<div id="text_counter">
		...
		<div id="details_of_user">
			...
			<button class="btn btn-danger" id="btn_block">Блокирай</button>
		</div>
	</section>
	<div id="update_container">
		<div style="background-color:#F5F6FA;" class="p-3 d-flex justify-content-between align-items-center">
			<h5 id="update_container_title" class="m-0 p-0">Актуализация на профил</h5>
		...
		<form class="" id="form_details" autocomplete="off">
			...
			<div class="form-group">
				...
				<input type="text" maxlength="10" name="txt_phone" placeholder="Въведете телефонен номер" id="phone_num" class="form-control">
			</div>
			<div class="form-group">
				<label>Адрес</label>
				<input type="text" name="txt_addr" id="address" placeholder="Въведете адрес" class="form-control">
			</div>
			<div class="form-group">
				<label>Биография</label>
				<textarea name="bio" class="" id="update_bio" placeholder="Запишете биография."></textarea>
			</div>
			<button class="btn btn-block" id="update_btn" style="border-radius:0px;">
				<span>Запазете промени</span>
			</button>
		</form>
	</div>
